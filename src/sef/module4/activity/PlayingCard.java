...
//		return 0;
	...
	public String toString() {
		...
		//END TODO #6
		String [] numbers = {"JOKER","ACE","TWO","THREE","FOUR","FIVE","SIX","SEVEN", "EIGHT","NINE","TEN","JACK","QUEEN","KING"};
		String [] suits = {"JOKER", "CLUBS", "DIAMONDS", "HEARTS", "SPADES"};
		
		if (this.number==0 || this.suit==0) return "JOKER";
		
		return String.format("%s of %s", numbers[this.number], suits[this.suit]);
	}
}
